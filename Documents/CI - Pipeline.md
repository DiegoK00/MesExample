...
| Job | Cosa fa | Runner |
|-----|---------|--------|
| `api-build` | Build Release dell'API (smoke check rapido senza test) | ubuntu-latest |
...
Vedere `.github/workflows/ci.yml` per il sorgente autoritativo. Di seguito lo snapshot corrente.
